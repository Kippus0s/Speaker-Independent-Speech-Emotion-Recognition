...
My results support the view that Deep Learning techniques achieve superior results on speaker independent speech emotion recognition, than traditional ML approaches which leverage domain knowledge via handcrafted audio features.
